    ...
    <>
      ...
      >
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 ${
                      isActive
                        ? "bg-primary-main text-white shadow-hover"
        ...
        <div className="p-4 border-t border-gray-200">
          <button
            onClick={logout}
            className="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-accent-main transition-all duration-200 w-full"
          >
            <LogOut size={20} />
