        ...
        <div className="card p-6">
          <div className="flex items-center justify-between mb-6">
            <button
              ...
              className="p-2 hover:bg-accent-main rounded-lg transition-colors"
            >
              <ChevronLeft size={20} />
            </button>
              ...
              return (
                <div
                  ...
                  className={`aspect-square border border-gray-200 rounded-lg p-2 hover:border-primary transition-colors cursor-pointer ${
                    hasAppointment ? "bg-primary-main bg-opacity-10" : ""
                  }`}
                >
                  <div className="text-sm font-medium text-gray-900">{day}</div>
                  {hasAppointment && (
                    <div className="mt-1">
                      <div className="w-2 h-2 bg-primary-main rounded-full mx-auto"></div>
                    </div>
                  )}
                </div>
              );
