    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="space-y-4 max-w-2xl">
          {[
            { key: 'newAppointment', label: 'New Appointment Booked', description: 'Get notified when a client books a new appointment' },
            { key: 'cancellation', label: 'Appointment Cancellation', description: 'Get notified when an appointment is cancelled' },
            { key: 'dailyReport', label: 'Daily Summary Report', description: 'Receive a daily summary of activities' },
            { key: 'weeklyReport', label: 'Weekly Performance Report', description: 'Receive weekly analytics and insights' }
          ].map((item) => (
