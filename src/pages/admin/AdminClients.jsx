...
const AdminClients = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setFormData({ name: '', email: '', phone: '', skinType: '', allergies: '' });
  };
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-200">
                ...
                <th className="text-left py-3 px-4 text-sm font-semibold text-gray-700">Next Visit</th>
            ...
            <tbody>
              {filteredClients.map((client) => (
                ...
                >
                  ...
                  <td className="py-4 px-4 text-gray-600">{client.lastVisit}</td>
                  <td className="py-4 px-4 text-gray-600">{client.nextVisit}</td>
                  <td className="py-4 px-4 text-gray-900">{client.totalSessions}</td>
                  <td className="py-4 px-4">
