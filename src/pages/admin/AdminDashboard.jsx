  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-gray-600 mt-1">Here's what's happening with your medspa today</p>
      </motion.div>
        ...
        >
          ...
          <ResponsiveContainer width="100%" height={250}>
            <LineChart data={chartData.monthly}>
              ...
              <YAxis stroke="#666" />
              <Tooltip />
              <Line type="monotone" dataKey="treatments" stroke="#f10e6a" strokeWidth={2} />
              <Line type="monotone" dataKey="clients" stroke="#ffa0c9" strokeWidth={2} />
            </LineChart>
          </ResponsiveContainer>
        ...
        >
          ...
          <ResponsiveContainer width="100%" height={250}>
            <BarChart data={chartData.revenue.slice(-6)}>
              ...
              <YAxis stroke="#666" />
              <Tooltip />
              <Bar dataKey="revenue" fill="#f10e6a" radius={[8, 8, 0, 0]} />
            </BarChart>
          </ResponsiveContainer>
        </motion.div>
      </div>
            ...
            <tbody>
              {upcomingAppointments.map((appointment) => (
                <tr key={appointment.id} className="border-b border-gray-100 hover:bg-accent transition-colors">
                  <td className="py-4 px-4 text-gray-900">{appointment.clientName}</td>
