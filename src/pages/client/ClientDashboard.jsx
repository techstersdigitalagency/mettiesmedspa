...
const ClientDashboard = () => {
  ...
  const healthMetrics = [
    { name: 'Next Visit', value: 'Oct 24', percentage: 68, color: '#f10e6a' },
    { name: 'Sessions', value: '8/12', percentage: 67, color: '#ff6b9d' },
    { name: 'Treatments', value: '5', percentage: 81, color: '#ffb4d4' },
    { name: 'Progress', value: '78%', percentage: 78, color: '#ffd4e8' }
  ];
  ...
  const treatments = [
    { name: 'Facial Treatment Series', completed: 8, total: 12, percentage: 67 },
    { name: 'Microdermabrasion Package', completed: 3, total: 6, percentage: 50 }
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Hello, {user?.name || 'Client'} 👋</h1>
        <p className="text-gray-600 mt-1">Detailed information about your treatments</p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        >
          <div className="card p-6 sm:p-8 bg-gradient-to-r from-[#f10e6a] to-[#ff6b9d] text-white relative overflow-hidden rounded-3xl">
            <div className="relative z-10">
              <h2 className="text-xl sm:text-2xl font-bold mb-2">Welcome to Your</h2>
              <h2 className="text-xl sm:text-2xl font-bold mb-6">Treatment Dashboard</h2>
        ...
        >
          <h3 className="text-lg sm:text-xl font-bold mb-4">Treatment Status</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Treatment Progress</h2>
              ...
              <div key={index} className="space-y-2">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#f10e6a] to-[#ff6b9d] flex items-center justify-center">
                      <Heart className="text-white" size={20} />
                    </div>
                    <div>
                      <p className="font-medium text-gray-900">{treatment.name}</p>
                      <p className="text-xs text-gray-500">{treatment.completed} of {treatment.total} sessions</p>
                    </div>
                  </div>
                  <span className="text-sm font-semibold text-gray-900">{treatment.percentage}%</span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div
                    className="h-2 rounded-full bg-gradient-to-r from-[#f10e6a] to-[#ff6b9d]"
                    style={{ width: `${treatment.percentage}%` }}
                  ></div>
                </div>
              </div>
            ))}
            <div className="mt-6 p-4 bg-gradient-to-br from-[#f10e6a]/10 to-[#ff6b9d]/10 rounded-lg border border-[#f10e6a]/20">
                  ...
                  <div className="flex -space-x-2">
                    {appointment.attendees.map((_, i) => (
                      <div
                        ...
                        style={{ backgroundColor: ['#f10e6a', '#ff6b9d'][i] }}
                      >
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 p-3 hover:bg-accent rounded-lg transition-colors cursor-pointer">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-gray-600 truncate">Your next appointment is confirmed...</p>
              </div>
            </div>
            <div className="flex items-center gap-3 p-3 hover:bg-accent rounded-lg transition-colors cursor-pointer">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-gray-600 truncate">Thank you for choosing us!</p>
              </div>
            </div>
          </div>
        </motion.div>
      ...
      >
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-lg sm:text-xl font-semibold text-gray-900">Your Documents</h3>
          <button className="text-primary text-sm hover:underline">See All →</button>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            ...
            <div key={index} className="flex items-center gap-3 p-4 border border-gray-200 rounded-xl hover:border-primary transition-colors cursor-pointer">
